...
HELP_BUTTONS = [
    (["H_B_1"], "help_callback hb1"),
    (["H_B_2"], "help_callback hb2"),
    (["H_B_3"], "help_callback hb3"),
    (["H_B_4"], "help_callback hb4"),
    (["H_B_5"], "help_callback hb5"),
    (["H_B_6"], "help_callback hb6"),
    (["H_B_7"], "help_callback hb7"),
    (["H_B_8"], "help_callback hb8"),
    (["H_B_9"], "help_callback hb9"),
    (["H_B_10"], "help_callback hb10"),
    (["H_B_11"], "help_callback hb11"),
    (["H_B_12"], "help_callback hb12"),
    (["H_B_13"], "help_callback hb13"),
    (["H_B_14"], "help_callback hb14"),
    (["H_B_15"], "help_callback hb15"),
    (["H_B_26"], "help_callback hb17"),
    (["H_B_25"], "help_callback hb16"),
    ("🎮 ғᴜɴ ɢᴀᴍᴇ", "help_callback hb21"),
    (["H_B_27"], "help_callback hb18"),
